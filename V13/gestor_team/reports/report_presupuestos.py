...
class ReportPresupuestos(models.AbstractModel):
    _name = 'report.presupuestos_pdf_reports.report_presupuestos'
    _description = 'Reporte Presupuestos'

    @api.model
    def _get_report_values(self, docids, data=None):
        raise UserError('Entrando 01')
