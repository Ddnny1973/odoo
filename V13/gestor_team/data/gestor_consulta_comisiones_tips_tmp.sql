-- Table: public.gestor_consulta_comisiones_tips_tmp

DROP TABLE public.gestor_consulta_comisiones_tips_tmp;

CREATE TABLE public.gestor_consulta_comisiones_tips_tmp
(
    fecha date,
    ...
    codigo_distribuidor character(250) COLLATE pg_catalog."default",
    ...
    clasificacion_del_plan character(250) COLLATE pg_catalog."default",
    es_multiplay character(250) COLLATE pg_catalog."default",
    es_upgrade character(250) COLLATE pg_catalog."default",
    es_linea_nueva character(250) COLLATE pg_catalog."default",
    ...
    fecha_de_activacion_en_punto_de_activacion character(250) COLLATE pg_catalog."default",
...
ALTER TABLE public.gestor_consulta_comisiones_tips_tmp
    OWNER to odoo;